  ...
  return (
    <>
      <div className="bg-black p-5">
        <div className="grid sm:grid-cols-3 m-5">
          <div>
            <h1 className="text-2xl text-yellow-300">Shop Adress</h1>
            <p className="text-xl">Level-4, 34, Awal Centre, Banani, Dhaka</p>
            <p className="text-xl">Email: solaiwala@yahoo.com</p>
        ...
        <p className="text-center text-2xl m-3 text-orange-700	">
          &copy; all rights reserved <span className="text-2xl font-bold text-yellow-300">soldaiwala</span> 2023
        </p>
      </div>
    </>
  );
